...
Let's use the SVM to classify two types of point, indicated as red and black circles below. The SVM algorithm pushes the parallel $\Va\cdot\Vx = b+1$ and $\Va\cdot\Vx = b-1$ hyperplanes outward until they hit the closest training points (the support vectors).
